...
ActiveRecord::Schema.define(version: 20141125152329) do
  ...
  create_table "question_subscriptions", force: true do |t|
  ...
  add_index "question_subscriptions", ["user_id", "question_id"], name: "index_question_subscriptions_on_user_id_and_question_id", unique: true, using: :btree
